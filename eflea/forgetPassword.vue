			...
			<form method="POST">
				<div class="login-form">
					...
					<div class="form-item" ref="passwordResetRef" :model="passwordReset">
						<input type="text" placeholder="Username" v-model="passwordReset.username">
						<input type="text" placeholder="Email" v-model="passwordReset.email">
						<input type="password" placeholder="New Password" v-model="passwordReset.newPassword">
						<input type="password" placeholder="Repeat Password" v-model="passwordReset.repeatNewPassword">
					</div>
	...
	export default {
		...
		methods: {
			async submit() {
				...
				const {
					data: res
				} = await this.$http.post("forgetPassword", this.passwordReset);
				if(res == "success"){
